...
from hawthorn.amqplib import RabbitMQFactory
...
def test_amqplib():
    ...
    example.consume(virtual_host, example_exchange, 'topic', example_queue, example_queue, False, test_callback, prefetch_count=2)
